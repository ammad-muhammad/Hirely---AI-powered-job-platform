...
export default function ResumeCheckerLoading() {
  return (
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 md:px-8 py-8 space-y-6">
        <Card className="p-6 md:p-8 space-y-6">
          <div className="space-y-2 text-center">
            <Skeleton variant="rectangular" className="w-12 h-12 rounded-xl mx-auto" />
            <Skeleton variant="text" className="w-64 h-7 mx-auto" />
            <Skeleton variant="text" className="w-80 h-4 mx-auto" />
          </div>

          <Skeleton variant="rectangular" className="h-44 rounded-2xl" />
        </Card>
      </main>
    </div>
  );
